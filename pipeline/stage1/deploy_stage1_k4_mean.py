...
from stage1.chem_stage1_per_task_offset import (  # noqa: E402
    COHORT_DIR,
    load_cohort_union,
)
...
DEFAULT_STAGE1_DIR = (
    _STANDALONE_ROOT / "_run_output" / "chem_stage1_candidates_fresh_v1"
)
DEFAULT_REFERENCE = (
    _STANDALONE_ROOT
    / "_run_output"
...
DEFAULT_OUTPUT_DIR = _STANDALONE_ROOT / "_run_output" / "chem_offset_k4_deployed_fresh_v1"
TASKS = (
    "NR-AR",
    "NR-AR-LBD",
    "NR-AhR",
