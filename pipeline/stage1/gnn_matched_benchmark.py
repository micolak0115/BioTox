# stage1/gnn_matched_benchmark.py
...
from stage1.loader import smiles_to_graph
from stage1.model import GAT, GCN, GIN, GraphSAGE
from stage1.splitter import DataSplit
from stage1.trainer import compute_pos_weight
from stage1.utils import seed_all
from stage2.utils import load_matched_split
