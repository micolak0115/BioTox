...
from stage1.splitter import DataSplit, generate_scaffold, scaffold_split_df
...
STAGE1_SPLIT_PATH = (
    HERE.parent.parent / "data" / "generated" / "transcriptomic_residual_learning"
    / "_run_output"
    / "matched_split_rebuilt"
    / "tox21_scaffold_df_split_chem_finetune_pool.pkl"
)
DEFAULT_OUTPUT_ROOT = (
    HERE.parent.parent / "data" / "generated" / "transcriptomic_residual_learning" / "paired_inputs_6h24h"
)
