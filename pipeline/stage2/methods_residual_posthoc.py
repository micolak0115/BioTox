...
from stage2.aggregate_offset_logistic import benjamini_hochberg
from stage2.utils import build_task_cell_frame, build_scaffold_dict, load_matched_split
from stage2.summarize_repeated_cv_publication import _validate_group
        ...
        for variant in manifest['variants']:
            ...
            for task in manifest['tasks']:
                ...
                for ((repeat, fold), group) in oof.groupby(['repeat_id', 'fold_id'], sort=True):
                    ...
                    _assert_close(group.bio_intercept, group.null_intercept, 'shared stage2/chem calibration', atol=0.0)
