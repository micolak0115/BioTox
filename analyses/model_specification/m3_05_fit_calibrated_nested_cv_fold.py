...
def _register_publication_alias(module_name: str, filename: str) -> None:
    """Expose sibling files in this directory under the import names used by run scripts."""
...
_register_publication_alias(
    "offset_ridge_fixed",
    "m3_16_optimize_fixed_offset_ridge.py",
)
_register_publication_alias(
    "offset_ridge_lbfgs",
    "m3_04_optimize_offset_ridge_lbfgs.py",
)
_register_publication_alias(
    "utils",
    "m3_14_shared_stage2_utilities.py",
)
...
DEFAULT_OUT_DIR = HERE / "_run_output" / "nested_cv_k4_fixed_calibration_v3"
