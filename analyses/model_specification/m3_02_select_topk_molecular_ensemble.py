...
from publication.utils import TOX21_TASKS  # noqa: E402


DEFAULT_STAGE1_DIR = HERE / "_run_output" / "chem_offset_valid_tuned_classical"
DEFAULT_OUTPUT_DIR = (
    HERE / "_run_output" / "stage1_topk_summary_fresh_v1"
)
FIXED_SEED = 1
K_REFERENCE = 4
