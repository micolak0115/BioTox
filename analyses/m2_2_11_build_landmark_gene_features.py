...
replicate-aggregated -- see bio/preprocess/align.py::get_embeddings; no
...
aggregated the same way bio/preprocess/aggregate.py does (median, its
default method).
...
from chem.splitter import DataSplit  # noqa: F401,E402  (needed for pickle.load to resolve the class)
...
PERT_TIME = 6.0
REPLICATE_AGG_METHOD = "median"  # matches bio/preprocess/aggregate.py's default
