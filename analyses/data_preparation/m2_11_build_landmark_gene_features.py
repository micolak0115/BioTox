...
replicate-aggregated -- see m2_06_align_to_plate_dmso_controls.py; no
...
aggregated the same way m2_07_aggregate_lincs_replicates.py does (median, its
default method).
...
from stage1.splitter import DataSplit  # noqa: F401,E402  (needed for pickle.load to resolve the class)
...
PERT_TIME = 6.0
REPLICATE_AGG_METHOD = "median"  # matches m2_07 aggregate's default
