...
\texttt{TableS1/TableS1_source_data.csv}
\subsection*{Table S2}
...
\texttt{TableS2/TableS2_source_data.csv}
\subsection*{Table S3}
Table S3. Stress-response cohort sizes and eligibility. n: labeled compounds, the denominator for active percentages. ✓: confirmatory-eligible; △: exploratory; ×: excluded. Bold active counts are < 20; eligibility is not statistical significance. Counts use the full 6-h cohort and compounds profiled at both times for 24 h. Total profiled (6 h/24 h): HA1E, 1,012/861; HepG2, 695/46; HT29, 1,005/606; MCF7, 1,332/1,316.
\texttt{TableS3/TableS3_source_data.csv}
\subsection*{Table S4}
...
\texttt{TableS6/TableS6_source_data.csv}
\subsection*{Table S7}
...
\texttt{TableS7/TableS7_source_data.csv}
\subsection*{Table S8}
...
\texttt{TableS8/TableS8_source_data.csv}
\subsection*{Table S9}
...
\texttt{TableS9/TableS9_source_data.csv}
\end{document}
