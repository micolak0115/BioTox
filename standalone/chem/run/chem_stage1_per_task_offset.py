...
from chem import classical_baseline  # noqa: E402
...
from publication.build_matched_cohort import ik_skeleton  # noqa: E402
...
CHEMPROP_ENV_PYTHON = os.environ.get(
    ...
    "/data/kyungan/miniconda3/envs/crisp_chemprop_env/bin/python",
)
CHEMPROP_SCRIPT = os.environ.get(
    "BIOTOX_CHEMPROP_SCRIPT",
    str(Path(__file__).resolve().parents[1] / "chem" / "chemprop_stage1_candidate.py"),
)
