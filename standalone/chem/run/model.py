...
class Fingerprint(nn.Module):
    ...
    def _init_feature_model(self):
        ...
        if self.probe_head is None:
            from chem.probe import ProbeHead
    ...
    def fit_probe(
        ...
        **kwargs,
        ...
        from chem.feature_probe import fit as feature_fit
    ...
    def predict_probe(self, test_df, **kwargs):
        from chem.feature_probe import predict as feature_predict
...
class UndirectedMPNN(nn.Module):
    ...
    def fit(self, split, pos_weight=None, **kwargs):
        ...
        from chem.trainer import UndirectedMPNN as Trainer
    ...
    def _embed_df(self, df, smiles_col: str, device):
        ...
        from chem.loader import smiles_to_pyg
    ...
    def fit_probe(
        ...
        """
        import copy
        from chem.trainer import get_loss_fn, compute_metrics, init_best_score, is_better, primary_metric
        ...
        # in_dim to hidden_dim, matching ProjectionMLP in bio+chem/model.py.
    ...
    def predict_probe(self, test_df, smiles_col: str = None, task_cols: list = None,
        ...
        from chem.trainer import compute_metrics
...
class Transformer(nn.Module, ABC):
    ...
    def fit(self, split, pos_weight=None, **kwargs):
        ...
        from chem.finetune import fit as finetune_fit
    ...
    def predict(self, test_df, **kwargs):
        ...
        from chem.finetune import predict as finetune_predict
    ...
    def fit_probe(
        ...
        **kwargs,
        ...
        from chem.probe import fit as probe_fit
    ...
    def predict_probe(self, test_df, **kwargs):
        ...
        from chem.probe import predict as probe_predict
