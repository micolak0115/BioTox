...
from chem.utils import seed_all, pick_gpu, load_pickle
from chem.featurizer import ATOM_FEATURE_DIM
from chem.loader import _load_graph_cache_payload
from chem.model import CHEM_ENCODERS, Fingerprint, UndirectedMPNN, Transformer
    ...
    if mode in {"probe", "finetuned_probe"}:
        ...
        if os.path.exists(os.path.join(probe_dir, "probe_head.pt")):
            try:
                ...
                from chem.probe import load_probe
