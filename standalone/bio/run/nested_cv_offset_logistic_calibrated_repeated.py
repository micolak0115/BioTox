...
from publication import nested_cv_offset_logistic_calibrated as calibrated
from publication.repeated_cv_inference import (
    repeated_cv_nadeau_bengio_test,
)
from publication.utils import stratified_scaffold_group_kfold
    ...
    if resolved_jobs == 1:
        ...
        for job_index, repeated_job in enumerate(repeated_jobs, start=1):
            ...
            if job_index == 1 or job_index % 10 == 0 or job_index == len(repeated_jobs):
                ...
                print(
                    "[repeated-calibrated-v1] serial progress: "
