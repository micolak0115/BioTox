...
def _register_bundled_package(name: str, *locations: Path) -> None:
    ...
    alias_root = Path(
        os.environ.get("BIOTOX_PACKAGE_ALIAS_ROOT", _STANDALONE_ROOT / "_pkg_alias")
    )
...
from publication.offset_ridge_fixed import (
    fixed_offset_ridge_objective_gradient,
    fit_fixed_offset_ridge_path,
    predict_fixed_offset_ridge,
)
from publication.offset_ridge_lbfgs import fit_offset_intercept_lbfgs
