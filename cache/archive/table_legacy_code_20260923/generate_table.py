...
LaTeX tables are stored as fenced LaTeX blocks in `.md` files. This legacy
bundle no longer writes figure files; figure generation belongs exclusively in
the figure-specific code directories.
"""
...
def build() -> dict[str, object]:
    ...
    for directory in (tables_dir, data_dir):
